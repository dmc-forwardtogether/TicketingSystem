        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="fh5co-hero-wrap">
                <div class="fh5co-hero-intro">
                    <h1 class="to-animate hero-animate-1">修改个人信息</h1>
                </div>
            </div>
        </div>
    </div>
            ...
            <form action="${pageContext.request.contextPath}/UpdateUserServlet" method="post">
                <div class="col-md-5">
                    <div class="form-group">
                        ...
                        <input placeholder="${user.user_username}" id="username" name="username" type="text" class="form-control input-lg">
                    </div>
                </div>
                <div class="col-md-5 col-md-offset-2 ">
                    <div class="form-group">
                        <label for="password" class="sr-only">密码</label>
                        <input placeholder="请输入原密码..." id="password" name="password" type="password" class="form-control input-lg">
                    </div>
                </div>
                <div class="col-md-5">
                    <div class="form-group">
                        <label for="birthday" class="sr-only">生日</label>
                        <input placeholder="${user.user_birthday}" id="birthday" name="birthday" type="text" class="form-control input-lg">
                    </div>
                </div>
                <div class="col-md-5 col-md-offset-2">
                    <div class="form-group">
                        <label for="re_password" class="sr-only">确认密码</label>
                        <input placeholder="请确认密码..." id="re_password" name="re_password" type="password" class="form-control input-lg">
                    </div>
                </div>
                <div class="col-md-5">
                    <div class="form-group">
                        <label for="telephone" class="sr-only">电话号码</label>
                        <input placeholder="${user.user_telephone}" id="telephone" name="telephone" type="text" class="form-control input-lg">
                    </div>
                </div>
                <div class="col-md-5 col-md-offset-2">
                    <div class="form-group">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea placeholder="${user.user_introduce}" name="message" id="message" class="form-control input-lg" rows="3"></textarea>
                    </div>
                </div>
                <div class="col-md-12">
